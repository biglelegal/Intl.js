...
function /* 9.2.1 */CanonicalizeLocaleList(locales) {
    ...
    while (k < len) {
        ...
        if (kPresent) {
            ...
            //     TypeError exception.
            if (kValue === null || typeof kValue !== 'string' && (typeof kValue === "undefined" ? "undefined" : _typeof$1(kValue)) !== 'object') throw new TypeError('String or Object type expected');
...
function GetFormatNumber() {
    var internal = this !== null && _typeof$2(this) === 'object' && getInternalProperties(this);
...
/* 11.3.3 */defineProperty(Intl.NumberFormat.prototype, 'resolvedOptions', {
    ...
    value: function value() {
        var prop = void 0,
            ...
            internal = this !== null && _typeof$2(this) === 'object' && getInternalProperties(this);
...
function generateSyntheticFormat(propName, propValue) {
    if (validSyntheticProps[propName] && validSyntheticProps[propName][propValue]) {
        ...
        return _ref2 = {
            ...
            _: _defineProperty({}, propName, propValue),
            extendedPattern: "{" + propName + "}"
        }, _defineProperty(_ref2, propName, propValue), _defineProperty(_ref2, "pattern12", "{" + propName + "}"), _defineProperty(_ref2, "pattern", "{" + propName + "}"), _ref2;
    }
}
...
function GetFormatDateTime() {
    var internal = this !== null && _typeof$3(this) === 'object' && getInternalProperties(this);
...
/* 12.3.3 */defineProperty(Intl.DateTimeFormat.prototype, 'resolvedOptions', {
    ...
    value: function value() {
        var prop = void 0,
            ...
            internal = this !== null && _typeof$3(this) === 'object' && getInternalProperties(this);
...
defineProperty(Intl.PluralRules.prototype, 'resolvedOptions', {
    ...
    value: function value() {
        var prop = void 0,
            ...
            internal = this !== null && _typeof$4(this) === 'object' && getInternalProperties(this);
